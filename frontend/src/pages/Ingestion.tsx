    ...
    <div className="bg-background text-on-surface min-h-screen selection:bg-primary/30">
      <aside className="fixed left-0 top-0 h-full w-[260px] bg-surface-container border-r border-outline-variant hidden lg:flex flex-col py-[24px] gap-[16px] z-50">
        ...
        <nav className="flex flex-col flex-grow">
          <a className="flex items-center gap-3 px-[24px] py-3 text-on-surface-variant hover:bg-surface-container-high transition-colors" href="#">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 0" }}>dashboard</span>
            <span className="text-label-md font-label-md">Dashboard</span>
          </a>
          <a className="flex items-center gap-3 px-[24px] py-3 text-primary font-bold border-r-2 border-primary bg-primary-container/10 opacity-90 transition-all duration-150" href="#">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>upload_file</span>
            <span className="text-label-md font-label-md">Ingestion</span>
          </a>
          <a className="flex items-center gap-3 px-[24px] py-3 text-on-surface-variant hover:bg-surface-container-high transition-colors" href="#">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 0" }}>fact_check</span>
            <span className="text-label-md font-label-md">Review Queue</span>
          </a>
          <a className="flex items-center gap-3 px-[24px] py-3 text-on-surface-variant hover:bg-surface-container-high transition-colors" href="#">
        ...
        <div className="mt-auto px-[24px]">
          <a className="flex items-center gap-3 py-3 text-on-surface-variant hover:bg-surface-container-high transition-colors" href="#">
      ...
      <main className="lg:ml-[260px] mt-[64px] p-[24px] lg:p-[32px] max-w-[1600px] mx-auto flex flex-col gap-[24px] min-h-[calc(100vh-64px)]">
        <header className="flex flex-col gap-[8px]">
          <h2 className="text-headline-lg font-headline-lg text-on-surface font-['Space_Grotesk']">Data Ingestion &amp; Pipeline</h2>
          <p className="text-body-lg font-body-lg text-on-surface-variant">Upload raw inventory files and monitor ETL job execution status.</p>
        </header>
